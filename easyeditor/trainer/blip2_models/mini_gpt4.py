...
class MiniGPT4(Blip2Base):
    ...
    def __init__(
        ...
        qformer_checkpoint="https://storage.googleapis.com/sfr-vision-language-research/LAVIS/models/BLIP2/blip2_pretrained_flant5xxl.pth", #"hugging_cache/blip2_pretrained_flant5xxl.pth",
        img_size=224,
        drop_path_rate=0,
        ...
        if self.low_resource:
            ...
            self.llama_model = LlamaForCausalLM.from_pretrained(
                ...
                torch_dtype=torch.float16,
                # device_map="auto"
                device_map=device_map if model_parallel else "auto"
            )
