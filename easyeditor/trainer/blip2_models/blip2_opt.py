...
class Blip2OPT(Blip2Base):
    ...
    def __init__(
        ...
        self.opt_model = OPTForCausalLM.from_pretrained(
            opt_model, torch_dtype=torch.float16, device_map=device_map if model_parallel else "auto"
        )
    ...
    def forward(self, samples):
        ...
        with self.maybe_autocast():
            outputs = self.opt_model(
                inputs_embeds=inputs_embeds.to(torch.float16), # inputs_embeds is the fusion of the image embeddings and the caption embeddings
